        ...
        <div className="text-center">
          <Link to="/" className="inline-flex items-center justify-center gap-2 mb-6 group">
            ...
            <span className="text-2xl font-heading font-bold text-slate-900 dark:text-white">
              Learn<span className="text-primary-600 dark:text-primary-400">Sphere</span>
            </span>
          </Link>
          <h2 className="text-3xl font-heading font-bold text-slate-900 dark:text-white">Welcome back</h2>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                {...registerField('email')}
                type="email"
                className={`w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-800 border ${errors.email ? 'border-red-500' : 'border-slate-200 dark:border-slate-700'} focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all dark:text-white`}
            ...
            <div>
              ...
              <input
                ...
                type="password"
                className={`w-full px-4 py-3 rounded-xl bg-white dark:bg-slate-800 border ${errors.password ? 'border-red-500' : 'border-slate-200 dark:border-slate-700'} focus:ring-2 focus:ring-primary-500 focus:border-transparent outline-none transition-all dark:text-white`}
                placeholder="••••••••"
              />
